<%-- 
    Document   : vhs_locmap
    Created on : Oct 14, 2018, 7:58:48 PM
    Author     : bachtiar
--%>
...
<html>
  <head>
    ...
    <title>VHS Location | Data Flow Meter | VHS KAI</title>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="menu-item-has-children dropdown">
              ...
              <ul class="sub-menu children dropdown-menu">
                ...
                <li class="divider"></li>
                <li><a href="#"><i class="fa fa-edit"></i> VHS Location Map</a></li>
                <li class="divider"></li>
              </ul>
            </li>
          ...
          <div class="page-header float-right">
            <div class="page-title">
              <ol class="breadcrumb text-right">
                <li class="active">General / VHS Location Map</li>
              </ol>
            </div>
          </div>
        </div>
